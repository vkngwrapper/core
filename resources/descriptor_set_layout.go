...
type DescriptorLayoutBinding struct {
	...
	Count        int
	ShaderStages core.ShaderStages
...
func (h *vulkanDescriptorSetLayout) Handle() loader.VkDescriptorSetLayout {
	return h.handle
}

func (h *vulkanDescriptorSetLayout) Destroy() error {
	return h.loader.VkDestroyDescriptorSetLayout(h.device, h.handle, nil)
}
