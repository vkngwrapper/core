...
type DescriptorSetOptions struct {
	DescriptorPool iface.DescriptorPool

	AllocationLayouts []iface.DescriptorSetLayout
...
type WriteDescriptorSetOptions struct {
	...
	TexelBufferView []iface.BufferView
...
type CopyDescriptorSetOptions struct {
	Source             iface.DescriptorSet
	SourceBinding      int
	SourceArrayElement int

	Destination             iface.DescriptorSet
