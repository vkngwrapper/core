...
void driverFuncPtrs_populate(PFN_vkGetInstanceProcAddr instanceProcAddr, DriverFuncPtrs *funcPtrs) {
    ...
    //Instance
    dest->vkCreateDevice = (PFN_vkCreateDevice)instanceProcAddr(NULL, "vkCreateDevice");
    dest->vkDestroyInstance = (PFN_vkDestroyInstance)instanceProcAddr(NULL, "vkDestroyInstance");
    dest->vkEnumeratePhysicalDevices = (PFN_vkEnumeratePhysicalDevices)instanceProcAddr(NULL, "vkEnumeratePhysicalDevices");
    dest->vkEnumerateDeviceExtensionProperties = (PFN_vkEnumerateDeviceExtensionProperties)instanceProcAddr(NULL, "vkEnumerateDeviceExtensionProperties");
    dest->vkEnumerateDeviceLayerProperties = (PFN_vkEnumerateDeviceLayerProperties)instanceProcAddr(NULL, "vkEnumerateDeviceLayerProperties");
    dest->vkGetPhysicalDeviceFeatures = (PFN_vkGetPhysicalDeviceFeatures)instanceProcAddr(NULL, "vkGetPhysicalDeviceFeatures");
    dest->vkGetPhysicalDeviceFormatProperties = (PFN_vkGetPhysicalDeviceFormatProperties)instanceProcAddr(NULL, "vkGetPhysicalDeviceFormatProperties");
    dest->vkGetPhysicalDeviceImageFormatProperties = (PFN_vkGetPhysicalDeviceImageFormatProperties)instanceProcAddr(NULL, "vkGetPhysicalDeviceImageFormatProperties");
    dest->vkGetPhysicalDeviceMemoryProperties = (PFN_vkGetPhysicalDeviceMemoryProperties)instanceProcAddr(NULL, "vkGetPhysicalDeviceMemoryProperties");
    dest->vkGetPhysicalDeviceProperties = (PFN_vkGetPhysicalDeviceProperties)instanceProcAddr(NULL, "vkGetPhysicalDeviceProperties");
    dest->vkGetPhysicalDeviceQueueFamilyProperties = (PFN_vkGetPhysicalDeviceQueueFamilyProperties)instanceProcAddr(NULL, "vkGetPhysicalDeviceQueueFamilyProperties");
    dest->vkGetPhysicalDeviceSparseImageFormatProperties = (PFN_vkGetPhysicalDeviceSparseImageFormatProperties)instanceProcAddr(NULL, "vkGetPhysicalDeviceSparseImageFormatProperties");
    ...
    dest->vkGetDeviceProcAddr = (PFN_vkGetDeviceProcAddr)instanceProcAddr(NULL, "vkGetDeviceProcAddr");
