...
func (m *MockGlobalDriver) CreateInstance(allocationCallbacks *loader.AllocationCallbacks, options core1_0.InstanceCreateInfo) (core1_0.CoreInstanceDriver, common.VkResult, error) {
	m.ctrl.T.Helper()
