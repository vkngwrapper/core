...
func NewDummyInstance(coreDriver driver.Driver, version common.APIVersion, instanceExtensions []string) core1_0.Instance {
	return impl1_2.CreateInstanceObject(coreDriver, mocks.NewFakeInstanceHandle(), version, instanceExtensions)
}
...
func NewDummySamplerYcbcrConversion(coreDriver driver.Driver, device core1_0.Device) core1_1.SamplerYcbcrConversion {
	builder := &impl1_2.DeviceObjectBuilderImpl1_1{}
	return builder.CreateSamplerYcbcrConversion(coreDriver, device.Handle(), mocks.NewFakeSamplerYcbcrConversionHandle(), device.APIVersion())
}

func NewDummyDescriptorUpdateTemplate(coreDriver driver.Driver, device core1_0.Device) core1_1.DescriptorUpdateTemplate {
	builder := &impl1_2.DeviceObjectBuilderImpl1_1{}
	return builder.CreateDescriptorUpdateTemplate(coreDriver, device.Handle(), mocks.NewFakeDescriptorUpdateTemplate(), device.APIVersion())
}
