...
func (m *MockLoader) AllocateCommandBuffers(o core1_0.CommandBufferAllocateOptions) ([]core1_0.CommandBuffer, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) AllocateDescriptorSets(o core1_0.DescriptorSetAllocateOptions) ([]core1_0.DescriptorSet, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateBuffer(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.BufferCreateOptions) (core1_0.Buffer, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateBufferView(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.BufferViewCreateOptions) (core1_0.BufferView, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateCommandPool(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.CommandPoolCreateOptions) (core1_0.CommandPool, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateComputePipelines(device core1_0.Device, pipelineCache core1_0.PipelineCache, allocationCallbacks *driver.AllocationCallbacks, o []core1_0.ComputePipelineCreateOptions) ([]core1_0.Pipeline, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateDescriptorPool(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.DescriptorPoolCreateOptions) (core1_0.DescriptorPool, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateDescriptorSetLayout(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.DescriptorSetLayoutCreateOptions) (core1_0.DescriptorSetLayout, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateDevice(physicalDevice core1_0.PhysicalDevice, allocationCallbacks *driver.AllocationCallbacks, options core1_0.DeviceCreateOptions) (core1_0.Device, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateEvent(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, options core1_0.EventCreateOptions) (core1_0.Event, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateFence(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.FenceCreateOptions) (core1_0.Fence, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateFrameBuffer(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.FramebufferCreateOptions) (core1_0.Framebuffer, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateGraphicsPipelines(device core1_0.Device, pipelineCache core1_0.PipelineCache, allocationCallbacks *driver.AllocationCallbacks, o []core1_0.GraphicsPipelineCreateOptions) ([]core1_0.Pipeline, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateImage(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, options core1_0.ImageCreateOptions) (core1_0.Image, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateImageView(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.ImageViewCreateOptions) (core1_0.ImageView, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreatePipelineCache(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.PipelineCacheCreateOptions) (core1_0.PipelineCache, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreatePipelineLayout(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.PipelineLayoutCreateOptions) (core1_0.PipelineLayout, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateQueryPool(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.QueryPoolCreateOptions) (core1_0.QueryPool, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateRenderPass(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.RenderPassCreateOptions) (core1_0.RenderPass, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateSampler(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.SamplerCreateOptions) (core1_0.Sampler, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateSemaphore(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.SemaphoreCreateOptions) (core1_0.Semaphore, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) CreateShaderModule(device core1_0.Device, allocationCallbacks *driver.AllocationCallbacks, o core1_0.ShaderModuleCreateOptions) (core1_0.ShaderModule, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader1_1) CreateDescriptorUpdateTemplate(device core1_0.Device, o core1_1.DescriptorUpdateTemplateCreateOptions, allocator *driver.AllocationCallbacks) (core1_1.DescriptorUpdateTemplate, common.VkResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader1_1) CreateSamplerYcbcrConversion(device core1_0.Device, o core1_1.SamplerYcbcrConversionCreateOptions, allocator *driver.AllocationCallbacks) (core1_1.SamplerYcbcrConversion, common.VkResult, error) {
	m.ctrl.T.Helper()
...
// GetQueue mocks base method.
func (m *MockLoader1_1) GetQueue(device core1_0.Device, o core1_1.DeviceQueueOptions) (core1_0.Queue, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetQueue", device, o)
	ret0, _ := ret[0].(core1_0.Queue)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetQueue indicates an expected call of GetQueue.
func (mr *MockLoader1_1MockRecorder) GetQueue(device, o interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetQueue", reflect.TypeOf((*MockLoader1_1)(nil).GetQueue), device, o)
}
