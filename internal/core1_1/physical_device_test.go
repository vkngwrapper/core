...
func TestVulkanPhysicalDevice_ExternalBufferProperties(t *testing.T) {
	...
	err = physicalDevice.Core1_1Instance().ExternalBufferProperties(
...
func TestVulkanPhysicalDevice_ExternalSemaphoreProperties(t *testing.T) {
	...
	err = physicalDevice.Core1_1Instance().ExternalSemaphoreProperties(
...
func TestVulkanPhysicalDevice_Features(t *testing.T) {
	...
	err = physicalDevice.Core1_1Instance().Features(outData)
	require.NoError(t, err)
...
func TestVulkanPhysicalDevice_FormatProperties(t *testing.T) {
	...
	err = physicalDevice.Core1_1Instance().FormatProperties(
...
func TestVulkanPhysicalDevice_ImageFormatProperties(t *testing.T) {
	...
	_, err = physicalDevice.Core1_1Instance().ImageFormatProperties(core1_1.ImageFormatOptions{
...
func TestVulkanPhysicalDevice_MemoryProperties(t *testing.T) {
	...
	err = physicalDevice.Core1_1Instance().MemoryProperties(&outData)
	require.NoError(t, err)
...
func TestVulkanPhysicalDevice_Properties(t *testing.T) {
	...
	err = physicalDevice.Core1_1Instance().Properties(&outData)
	require.NoError(t, err)
...
func TestVulkanPhysicalDevice_QueueFamilyProperties(t *testing.T) {
	...
	outData, err := physicalDevice.Core1_1Instance().QueueFamilyProperties(nil)
	require.NoError(t, err)
...
func TestVulkanPhysicalDevice_SparseImageFormatProperties(t *testing.T) {
	...
	outData, err := physicalDevice.Core1_1Instance().SparseImageFormatProperties(
...
func TestPhysicalDeviceIDOutData(t *testing.T) {
	...
	err = physicalDevice.Core1_1Instance().Properties(
		&properties,
	)
	require.NoError(t, err)
...
func TestMultiviewPropertiesOutData(t *testing.T) {
	...
	err = physicalDevice.Core1_1Instance().Properties(&properties)
	require.NoError(t, err)
...
func TestDevice16BitStorageOutData(t *testing.T) {
	...
	outData := &core1_1.PhysicalDevice16BitStorageFeaturesOutData{}
	features := &core1_1.DeviceFeaturesOutData{
		HaveNext: common.HaveNext{Next: outData},
	}

	err = physicalDevice.Core1_1Instance().Features(features)
	require.NoError(t, err)
...
func TestMultiviewFeaturesOptions(t *testing.T) {
	...
	device, _, err := loader.CreateDevice(physicalDevice, nil, core1_0.DeviceCreateOptions{
		...
		HaveNext: common.HaveNext{
			core1_1.PhysicalDeviceMultiviewFeaturesOptions{
				Multiview:                   true,
...
func TestMultiviewFeaturesOutData(t *testing.T) {
	...
	var outData core1_1.PhysicalDeviceMultiviewFeaturesOutData
	features := core1_1.DeviceFeaturesOutData{
		HaveNext: common.HaveNext{&outData},
	}
...
func TestPhysicalDeviceProtectedMemoryFeaturesOptions(t *testing.T) {
	...
	device, _, err := loader.CreateDevice(physicalDevice, nil, core1_0.DeviceCreateOptions{
		...
		HaveNext: common.HaveNext{
			core1_1.PhysicalDeviceProtectedMemoryFeaturesOptions{
...
func TestPhysicalDeviceProtectedMemoryFeaturesOutData(t *testing.T) {
	...
	var outData core1_1.PhysicalDeviceProtectedMemoryFeaturesOutData
	features := core1_1.DeviceFeaturesOutData{
		HaveNext: common.HaveNext{&outData},
	}
...
func TestSamplerYcbcrFeaturesOptions(t *testing.T) {
	...
	device, _, err := loader.CreateDevice(
		...
		core1_0.DeviceCreateOptions{
			...
			HaveNext: common.HaveNext{
				core1_1.PhysicalDeviceSamplerYcbcrFeaturesOptions{
...
func TestSamplerYcbcrFeaturesOutData(t *testing.T) {
	...
	err = physicalDevice.Core1_1Instance().Features(
	...
	require.NoError(t, err)
	require.Equal(t, core1_1.PhysicalDeviceSamplerYcbcrFeaturesOutData{
		SamplerYcbcrConversion: true,
	}, outData)
}
...
func TestPhysicalDeviceShaderDrawParametersFeaturesOptions(t *testing.T) {
	...
	device, _, err := loader.CreateDevice(physicalDevice, nil, core1_0.DeviceCreateOptions{
		...
		HaveNext: common.HaveNext{
			core1_1.PhysicalDeviceShaderDrawParametersFeaturesOptions{
...
func TestPhysicalDeviceShaderDrawParametersFeaturesOutData(t *testing.T) {
	...
	var outData core1_1.PhysicalDeviceShaderDrawParametersFeaturesOutData
	features := core1_1.DeviceFeaturesOutData{
		HaveNext: common.HaveNext{&outData},
	}
...
func TestVariablePointersFeatureOutData(t *testing.T) {
	...
	err = physicalDevice.Core1_1Instance().Features(&core1_1.DeviceFeaturesOutData{
...
func TestDeviceGroupOptions(t *testing.T) {
	...
	device, _, err := loader.CreateDevice(physicalDevice1, nil, core1_0.DeviceCreateOptions{
		...
		HaveNext: common.HaveNext{Next: core1_1.DeviceGroupDeviceOptions{
...
func TestMemoryAllocateFlagsOptions(t *testing.T) {
	...
	memory, _, err := loader.AllocateMemory(device, nil,
		core1_0.MemoryAllocateOptions{
			AllocationSize:  1,
			MemoryTypeIndex: 3,
			HaveNext: common.HaveNext{Next: core1_1.MemoryAllocateFlagsOptions{
...
func TestDevice16BitStorageOptions(t *testing.T) {
	...
	storage := core1_1.PhysicalDevice16BitStorageFeaturesOptions{
