...
func (d *VulkanPhysicalDevice) Features() *options.PhysicalDeviceFeatures {
	allocator := cgoparam.GetAlloc()
	defer cgoparam.ReturnAlloc(allocator)
...
func (d *VulkanPhysicalDevice) ImageFormatProperties(format common.DataFormat, imageType common.ImageType, tiling common.ImageTiling, usages common.ImageUsages, flags options.ImageFlags) (*core1_0.ImageFormatProperties, common.VkResult, error) {
	allocator := cgoparam.GetAlloc()
	defer cgoparam.ReturnAlloc(allocator)
...
func createPhysicalDeviceFeatures(f *C.VkPhysicalDeviceFeatures) *options.PhysicalDeviceFeatures {
	return &options.PhysicalDeviceFeatures{
