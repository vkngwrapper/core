...
func PromoteDevice(device core1_0.Device) core1_1.Device {
	...
	return device.Driver().ObjectStore().GetOrCreate(
		...
		func() any {
			return &VulkanDevice{
				Device: core1_1.PromoteDevice(device),
...
func (d *VulkanDevice) CreateRenderPass2(allocator *driver.AllocationCallbacks, options core1_2.RenderPassCreateOptions) (core1_0.RenderPass, common.VkResult, error) {
...
func (d *VulkanDevice) GetBufferDeviceAddress(o core1_2.BufferDeviceAddressOptions) (uint64, error) {
	arena := cgoparam.GetAlloc()
	defer cgoparam.ReturnAlloc(arena)
...
func (d *VulkanDevice) GetBufferOpaqueCaptureAddress(o core1_2.BufferDeviceAddressOptions) (uint64, error) {
	arena := cgoparam.GetAlloc()
	defer cgoparam.ReturnAlloc(arena)
...
func (d *VulkanDevice) GetDeviceMemoryOpaqueCaptureAddress(o core1_2.DeviceMemoryOpaqueAddressOptions) (uint64, error) {
	arena := cgoparam.GetAlloc()
	defer cgoparam.ReturnAlloc(arena)
...
func (d *VulkanDevice) SignalSemaphore(o core1_2.SemaphoreSignalOptions) (common.VkResult, error) {
	arena := cgoparam.GetAlloc()
	defer cgoparam.ReturnAlloc(arena)
...
func (d *VulkanDevice) WaitSemaphores(timeout time.Duration, o core1_2.SemaphoreWaitOptions) (common.VkResult, error) {
	arena := cgoparam.GetAlloc()
	defer cgoparam.ReturnAlloc(arena)
